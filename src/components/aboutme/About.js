        ...
        <>
            <div className="d-flex flex-column justify-content-center align-items-center">
                ...
                <div className="mt-5" style={{ width: "70%" }}>
                    <p className="testo-viola-scuro fs-3 text-center lh-sm text-justify comfortaa-about">Appassionata di informatica e programmazione, sempre alla ricerca di nuove sfide e opportunità di apprendimento, sono determinata a padroneggiare nuovi linguaggi di programmazione e ad abbracciare le più recenti tecnologie.
